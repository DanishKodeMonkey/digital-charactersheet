...
import { centralizationReducer, centralState, State, Action } from "./CentralisationLayer.ts"
...
// establish context
const CentralizationContext = createContext<CentralizationContextProps | undefined>(undefined)

// Establish provider

export const CentralizationProvider: React.FC<CentralizationProviderProps> = ({children}) =>{
...
export const useCentralization = (): CentralizationContextProps =>{
    ...
    if(!context){
        throw new Error('useCentralization must be used within a centralisationProvider')
    }
    return context;
}