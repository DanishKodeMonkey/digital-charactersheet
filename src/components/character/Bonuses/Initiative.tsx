    ...
    return(
        ...
        <div className="flex  justify-between  gap-2">
            <div  className="flex flex-col-reverse self-start">
                ...
                <input className="input-base w-full" type="number" name="initiativeTotal" id="initiativeTotal" value={initiativeTotal} disabled />
            </div>
            <span className="input-label pt-4">=</span>
            <div  className="flex flex-col-reverse">
                <label className="input-label" htmlFor="dexMod">Dex <br /> Modifier</label>
                <input className="input-base  w-full" type="number" name="dexMod" id="dexMod" value={dexterity} disabled/>
            </div>
            <span className="input-label pt-4">+</span>
            <div  className="flex flex-col-reverse">
                <label className="input-label" htmlFor="miscMod">Misc <br /> modifier</label>
                <input className="input-base  w-full" type="number" name="miscMod" id="miscMod" value={miscModifier} onChange={handleMiscModifierChange} />
            </div>
        </div>
        </div>
    )
