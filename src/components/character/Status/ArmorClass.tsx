  ...
  return (
      ...
      <div className="grid grid-rows-2">
        ...
        <div className="grid grid-cols-[repeat(14,minmax(0,1fr))] font-bold items-center text-center">
          ...
          <span className="col-span-1 text-xs max-sm:hidden">+</span>
          <span className="col-span-2 md:col-span-1 text-xs">Armor<br />Bonus</span>
          <span className="col-span-1 text-xs max-sm:hidden">+</span>
          <span className="col-span-2 md:col-span-1 text-xs">Dex<br />Modifier</span>
          <span className="col-span-1 text-xs max-sm:hidden">-</span>
          <span className="col-span-2 md:col-span-1 text-xs">Size<br />Modifier</span>
          <span className="col-span-1 text-xs max-sm:hidden">+</span>
          <span className="col-span-2 md:col-span-1 text-xs">Natural<br />Armor</span>
          <span className="col-span-1 text-xs max-sm:hidden">+</span>
          <span className="col-span-2 md:col-span-1 text-xs">Misc<br />Modifier</span>
        </div>
