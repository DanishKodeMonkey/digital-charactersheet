    ...
    return(
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" disabled={loading || Object.keys(validationErrors).length > 0}>{loading ? "Signing in..." : Object.keys(validationErrors).length > 0 ? "Changes required " : "Sign In"}</button>
            </form>
            <p>Don't have an account? <a href="/auth/signup">Sign up!</a></p>

            {/* HUSKAT: Implement Oauth logic */}
            <button onClick={() => alert("Coming soon")} className="oath-btn">Sign in with Google</button>
            <button onClick={() => alert("Coming soon")} className="oath-btn">Sign in with Discord</button>
